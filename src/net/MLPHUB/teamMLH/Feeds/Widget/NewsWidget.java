package net.MLPHUB.teamMLH.Feeds.Widget;
...
public class NewsWidget extends AppWidgetProvider 
{
	...
	public void onReceive(Context context, Intent intent) {
	    if (intent.getAction().equals("net.MLPHUB.teamMLH.Feeds.Widget.ACTUALIZAR_WIDGET")) {
            ...
            AppWidgetManager appWidgetManager, int widgetId)
	{
		...
		RemoteViews controles =
		    new RemoteViews(context.getPackageName(), R.layout.mlh_feeds_widget_newswidget);
		
		//Asociamos los 'eventos' al widget
		Intent intent = new Intent("net.MLPHUB.teamMLH.widget.ACTUALIZAR_WIDGET");
		intent.putExtra(
