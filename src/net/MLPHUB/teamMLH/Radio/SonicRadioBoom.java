...
public class SonicRadioBoom extends Activity{

	private String TAG = getClass().getSimpleName();
		private SharedPreferences prefs;
		private TextView songName, textState;
		
		private final String EMISORA = "srb";
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        {
	        	getWindow().setBackgroundDrawableResource(R.drawable.srb_back);
	        }
	        else
	        {
	        	getWindow().setBackgroundDrawableResource(prefs.getInt("backgroundRadio", R.drawable.srb_back));
	        }
	        ...
	        Typeface fontSegoe = Typeface.createFromAsset(getAssets(), "fonts/SEGOEUIL.TTF");
	 		...
	 		String title = getString(R.string.srbradiotitle).toLowerCase();
		  ...
		  if (!radioIsRun||!EMISORA.equals(radio)) 
		  {
			  ...
			  if(checkConnectivity())
			  {
				 if(radioIsRun)
				  ...
				  radioService.putExtra("radio", "srb");
				  radioService.putExtra("streamRadio", "http://radio.ponyvillelive.com:8020/stream?sid=1");
				  radioService.putExtra("currentSong", "http://radio.ponyvillelive.com:8020/currentsong?sid=1");
	  ...
	  public void goShareSong(View v){
		  ...
		  {		
				...
				shareAction.putExtra(Intent.EXTRA_TEXT, getString(R.string.listen)+" "+prevSong 
																	+ " " + getString(R.string.on)+ " @SonicRadioBoom " 
	 ...
	 {
		 Intent homeI = new Intent(SonicRadioBoom.this, MainActivity.class);
		 startActivity(homeI);
		 finish();
